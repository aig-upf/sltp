...
\begin{itemize}
 ...
 \item $D$: maximum allowed value for $V(s)$ for any $s$ in the training set.\footnote{This is to be improved based on $V^*(s)$.}
\end{itemize}
...
\begin{itemize}
 ...
 \item $V(s) \leq d$ for $s$ alive, and $d \in [0, D]$.
