(define (domain FOND_blocks-clear-x_3)
    ...
    (:action Pick-other
        :precondition (and (not (zero nother_A)) (not (hold_A)) (not (hold-other_A)) (q nabove_A))
    ...
    (:action Put-x-above-some
        :precondition (and (not (zero nother_A)) (hold_A) (q nabove_A))
