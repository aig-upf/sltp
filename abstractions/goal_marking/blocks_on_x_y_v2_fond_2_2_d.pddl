(define (domain FOND_blocks_2_2)
    ...
    (:action Push_n_b_d0_b0
        :precondition (and (stack-depth d0) (not (in-stack n_b)) (bitvalue d0 b0))
        :effect (and (not (stack-depth d0)) (stack-depth d1) (in-stack n_b) (stack-idx n_b d1) (not (bitvalue d0 b0)) (bitvalue d1 b0) (bitvalue d1 b1) (bitvalue d1 b2))
    )
    (:action Push_n_b_d0_b1
        :precondition (and (stack-depth d0) (not (in-stack n_b)) (bitvalue d0 b1) (not (bitvalue d0 b0)))
        :effect (and (not (stack-depth d0)) (stack-depth d1) (in-stack n_b) (stack-idx n_b d1) (not (bitvalue d0 b1)) (bitvalue d0 b0) (bitvalue d1 b0) (bitvalue d1 b1) (bitvalue d1 b2))
    )
    (:action Push_n_b_d0_b2
        :precondition (and (stack-depth d0) (not (in-stack n_b)) (bitvalue d0 b2) (not (bitvalue d0 b1)) (not (bitvalue d0 b0)))
        :effect (and (not (stack-depth d0)) (stack-depth d1) (in-stack n_b) (stack-idx n_b d1) (not (bitvalue d0 b2)) (bitvalue d0 b1) (bitvalue d0 b0) (bitvalue d1 b0) (bitvalue d1 b1) (bitvalue d1 b2))
    )
    ...
    (:action Push_n_b_d1_b0
        :precondition (and (stack-depth d1) (not (in-stack n_b)) (bitvalue d1 b0))
        :effect (and (not (stack-depth d1)) (stack-depth d2) (in-stack n_b) (stack-idx n_b d2) (not (bitvalue d1 b0)) (bitvalue d2 b0) (bitvalue d2 b1) (bitvalue d2 b2))
    )
    (:action Push_n_b_d1_b1
        :precondition (and (stack-depth d1) (not (in-stack n_b)) (bitvalue d1 b1) (not (bitvalue d1 b0)))
        :effect (and (not (stack-depth d1)) (stack-depth d2) (in-stack n_b) (stack-idx n_b d2) (not (bitvalue d1 b1)) (bitvalue d1 b0) (bitvalue d2 b0) (bitvalue d2 b1) (bitvalue d2 b2))
    )
    (:action Push_n_b_d1_b2
        :precondition (and (stack-depth d1) (not (in-stack n_b)) (bitvalue d1 b2) (not (bitvalue d1 b1)) (not (bitvalue d1 b0)))
        :effect (and (not (stack-depth d1)) (stack-depth d2) (in-stack n_b) (stack-idx n_b d2) (not (bitvalue d1 b2)) (bitvalue d1 b1) (bitvalue d1 b0) (bitvalue d2 b0) (bitvalue d2 b1) (bitvalue d2 b2))
    )
    (:action Pop_n_a_d1
    ...
    (:action Pop_n_b_d1
        :precondition (and (stack-depth d1) (in-stack n_b) (stack-idx n_b d1))
        :effect (and (stack-depth d0) (not (stack-depth d1)) (not (in-stack n_b)) (not (stack-idx n_b d1)))
    )
    (:action Pop_n_a_d2
    ...
    (:action Pop_n_b_d2
        :precondition (and (stack-depth d2) (in-stack n_b) (stack-idx n_b d2))
        :effect (and (stack-depth d1) (not (stack-depth d2)) (not (in-stack n_b)) (not (stack-idx n_b d2)))
    )
    (:action action_1
